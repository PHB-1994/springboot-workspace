...
public class EmailServiceImpl implements EmailService{
    ...
    public String sendMail(String htmlName, String email) {
        ...
        try{
            ...
            //      로고 이미지를 보낼 때 보낼 이지미와 이미지를 보낼 때 담을 id 명칭 작성
    ...
    // HTML 파일을 읽어와 String 으로 변환(타임리프 템플릿 사용해서 html 가져오기)
    public String loadHtml(String authKey, String htmlName){
        ...
        // return templateEngine.process("pages/auth" + htmlName, context); 아래처럼 경로가 됨
        // pages/authsignup.html
        // return templateEngine.process("pages/auth/" + htmlName, context); 마지막에 / 추가
    ...
    public String createAuthKey(){
        ...
        for(int i = 0; i < 6; i++){ // key 의 내부가 6자리로 채워지기 위해 0 ~ 5 까지 5번 반복
            ...
            *************/
            ...
            if(sel1 == 0){ // sel1 뽑힌 숫자가 0 이면 숫자 당첨~!
                ...
                // 우선은 무작위로 A 부터 Z 까지 대문자를 생성해서 ch 저장
                char ch = (char)(Math.random() * 26 + 65); // A ~ Z (65 ~ 65 + 26)

                // 또 랜덤뽑기를 해서 0 이 나오면 소문자~ 1이 나오면 대문자~
